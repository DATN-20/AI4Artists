          ...
          <Tabs defaultValue="local" className="mx-10 flex h-full flex-col">
            ...
            <TabsContent value="local" className="mb-10 h-full">
              <div
                ...
                onDrop={handleDrop}
                className="mt-5 h-full flex justify-center items-center cursor-pointer space-y-0 rounded-xl border-2 border-dashed border-black p-5 text-center dark:border-white"
              >
                {selectedImage ? (
                  <img
