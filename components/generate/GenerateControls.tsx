    ...
    <>
      <div className="flex">
        ...
        <button
          ...
          className="ml-4 hidden items-center justify-center rounded-full bg-gradient-linear from-sky-300 to-primary-700 px-4 py-3 font-bold text-white hover:bg-purple-700 lg:flex"
        >
